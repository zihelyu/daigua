...
if($action=='install'){
    ...
    if(empty($host) || empty($port) || empty($user) || empty($pwd) || empty($database)){
        ...
        if(empty($errorMsg)){
            ...
            $sqls=explode(';', $sqls);
            $sqls[]="INSERT INTO `dg_webs` (`zid`, `uid`, `domain`, `qq`, `name`, `title`, `endtime`) VALUES ('1', '10000', '{$_SERVER['HTTP_HOST']}', '10000', '等级代挂系统', '等级代挂系统','2020-12-31 08:00:00')";
			$syskey = random(32);
...
<div class="container"><br>
    ...
    <footer class="footer">
        <pre><center>Powered by 彩虹 ! QQ:1277180438</center></pre>
    </footer>
</div>
</body>
</html>
